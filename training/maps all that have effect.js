...
maps.push({
    "ID": 21,
    "Internal Name": "MIHA03",
    "Name": "Mt. Panorama",
    "Description": "Unused Screen",
    "Like1": 5,
    "Like2": "none",
    "Like3": "none",
    "Like4": "none",
...
maps.push({
    "ID": 30,
    "Internal Name": "TUNN07",
    "Name": "Lava Cave",
    "Description": "Entrance, Volcano active",
    "Like1": 0,
    "Like2": "none",
    "Like3": "none",
    "Like4": "none",
...
for(var b=0;b<maps.length;b++){
   maps[b].Likes=[];
   if(maps[b].Like1!="none"){
      maps[b].Likes.push(maps[b].Like1);
   }
   if(maps[b].Like2!="none"){
      maps[b].Likes.push(maps[b].Like2);
   }
   if(maps[b].Like3!="none"){
      maps[b].Likes.push(maps[b].Like3);
   }
   if(maps[b].Like4!="none"){
      maps[b].Likes.push(maps[b].Like4);
   }
if(maps[b].Likes.length===0){
   maps[b].Likes=0;
}
   maps[b].Dislikes=[];
   if(maps[b].Dislike1!="none"){
      maps[b].Dislikes.push(maps[b].Dislike1);
   }
   if(maps[b].Dislike2!="none"){
      maps[b].Dislikes.push(maps[b].Dislike2);
   }
   if(maps[b].Dislike3!="none"){
      maps[b].Dislikes.push(maps[b].Dislike3);
   }
   if(maps[b].Dislike4!="none"){
      maps[b].Dislikes.push(maps[b].Dislike4);
   }
if(maps[b].Dislikes.length===0){
   maps[b].Dislikes=0;
}
if(maps[b].Dislikes===0&&maps[b].Likes===0){
   maps.splice(b,1);
}
